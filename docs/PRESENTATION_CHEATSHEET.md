...
- **Deterministic Heuristics:** Provide fast, zero-delay, explainable baselines for high-velocity known threats (DDoS, port scans, periodic C2 timing).
- **Supervised ML (LightGBM):** Classifies complex multi-feature tabular patterns across 52 statistical flow and entity dimensions in $< 0.2\text{ ms}$.
...
### 10. How is C2 Beaconing detected without FFT or payload inspection?
C2 beaconing is detected using microsecond inter-arrival timing statistics, sample standard deviation, coefficient-of-variation-based periodicity ($1.0 - \frac{\text{jitter}}{50.0}$), jitter analysis, and repeated destination communication across sliding windows.

### 11. How are packet sequences modeled without deep neural networks?
The flow engine tracks initial packet lengths and inter-arrival sequences, deriving lightweight statistical aggregates (means, variances, packet rates, upload/download ratios) optimized for sub-millisecond line-rate streaming inference.

### 12. Why Multi-Signal Fusion?
...
### 13. How is false-positive reduction handled?
...
### 14. How is forensic provenance provided?
...
### 15. What are the measured empirical results?
...
### 16. What are the known weaknesses?
...
### 17. What happens under adversarial C2 jitter?
...
### 18. What happens under low-and-slow port scanning?
...
### 19. How is the zero-return-path constraint guaranteed?
